 ...
 * 
 *         Ein Objekt der Klasse Pruefungsleistung besteht aus "note"(int) und
 *         "modulname"(String). Er repraesentiert eine Pruefungsleistung eines
 *         Studenten.
 *
 */
...
public class Pruefungsleistung {
	...
	/**
	 * Ueberschreiben der toString Methode Note und Modulname werden ausgegeben.
	 */
