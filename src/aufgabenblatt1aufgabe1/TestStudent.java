...
public class TestStudent {
	 ...
	 * 
	 * Der Test ist erfolgreich wenn der Student mit der kleinsten
	 * Matrikelnummer an erster Stelle der Liste ist(nach sortieren).
	 * 
	 */
	@Test
	...
	/**
	 * Test der Klasse CompareName, welche Comparator implementiert.
	 * Wenn ein Student lexikographisch vor einem anderen steht, so liefert das ergebnis des Vergleichs -1 zurueck.
	 * Wenn beide gleich sind 0.
	 * Wenn ein Student nach einem anderen steht, so liefert er das ergebnis des Vergleichs 1 zurueck.
	 */
	@Test 
	public void testComparator() {
		...
		assertEquals("Fehler: Erwarteter Wert -1(Name kleiner)", -1, comparator1.compare(student1, student2));
		
		assertEquals("Fehler: Erwarteter Wert 1(Name groesser)", 1, comparator1.compare(student2, student1));
		
		assertEquals("Fehler: Erwarteter Wert 0(Namen gleich)", 0, comparator1.compare(student2, student2));
