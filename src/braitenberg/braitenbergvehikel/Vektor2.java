...
public class Vektor2 {
	...
	public Vektor2 rotiere(double winkelBogenmass) {
		double x = Math.cos(winkelBogenmass) * koordinaten[0] - Math.sin(winkelBogenmass) * koordinaten[1];
		double y = Math.sin(winkelBogenmass) * koordinaten[0] + Math.cos(winkelBogenmass) * koordinaten[1];
